...
const getPosts = async () => {
    ...
    // Sort posts while handling potential undefined createdAt values
    return posts.sort((a, b) => {
        const aTime = a.createdAt ? a.createdAt.toMillis() : 0; // Default to 0 if undefined
        const bTime = b.createdAt ? b.createdAt.toMillis() : 0; // Default to 0 if undefined
